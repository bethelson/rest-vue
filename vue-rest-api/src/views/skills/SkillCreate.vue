    ...
    <div class="mt-12">
        <form class="max-w-md mx-auto p-4 bg-white shadow-md rounded-md" @submit.prevent="storeSkill(form)">
            <div class="space-y-6">
                ...
                <div class="mb-6">
                    <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your password</label>
                ...
                <div class="mt-4">
                    <button type="submit" class="store px-4 py-2 bg-indigo-500 hover:bg-indigo-700 text-white rounded">Submit</button>
                </div>
            </div>
        </form>
    </div>
